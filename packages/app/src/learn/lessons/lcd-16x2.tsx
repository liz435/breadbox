    ...
    <LearnLayout>
      ...
      <Section title="What you'll build">
        <p className="text-sm leading-relaxed">
          ...
          and the <code className="text-foreground">LiquidCrystal</code> library.
        </p>
      </Section>
      ...
      <Section title="How it works">
        <p className="text-sm leading-relaxed">
          The{" "}
          <code className="text-foreground">LiquidCrystal lcd(12, 11, 5, 4, 3, 2)</code>{" "}
        ...
        <p className="text-sm leading-relaxed">
          <code className="text-foreground">lcd.begin(16, 2)</code> initializes the display
          for 16 columns and 2 rows. After that,{" "}
          <code className="text-foreground">lcd.print()</code> writes characters starting
          at the current cursor position, and{" "}
          <code className="text-foreground">lcd.setCursor(col, row)</code> moves the cursor
      ...
      <Section title="Why does the counter need trailing spaces?">
        <p className="text-sm leading-relaxed">
          ...
          <code className="text-foreground">"s  "</code> (two trailing spaces) to overwrite
