    ...
    <LearnLayout>
      ...
      <Section title="What you'll build">
        <p className="text-sm leading-relaxed">
          ...
          <code className="text-gray-200">D9</code> that sweeps smoothly from 0{"\u00b0"}
          to 180{"\u00b0"} and back, one degree at a time. The Arduino's built-in{" "}
          <code className="text-gray-200">Servo</code> library handles the timing signal.
        </p>
      </Section>
      ...
      <Section title="How it works">
        <p className="text-sm leading-relaxed">
          ...
          <code className="text-gray-200">Servo</code> library abstracts all of this: you
          call <code className="text-gray-200">myServo.attach(9)</code> once in{" "}
          <code className="text-gray-200">setup()</code>, and then{" "}
          <code className="text-gray-200">myServo.write(angle)</code> anywhere in{" "}
          <code className="text-gray-200">loop()</code> to set the position in degrees.
        </p>
        <p className="text-sm leading-relaxed">
          The two <code className="text-gray-200">for</code> loops increment and then
      ...
      <Section title="Why not use analogWrite() for a servo?">
        <p className="text-sm leading-relaxed">
          ...
          50 Hz. The <code className="text-gray-200">Servo</code> library uses hardware
