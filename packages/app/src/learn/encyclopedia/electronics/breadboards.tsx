    ...
    <LearnLayout>
      ...
      <Section title="The anatomy">
        <p className="text-sm leading-relaxed">
          ...
          <strong className="text-foreground">main area</strong> with rows
          of five holes, and two pairs of long{" "}
          <strong className="text-foreground">power rails</strong> running
      ...
      <Section title="Rows of five">
        <p className="text-sm leading-relaxed">
          ...
          <strong className="text-foreground">five holes</strong> joined
        ...
        <Note>
          Adjacent rows are <em className="text-foreground">not</em>{" "}
      ...
      <Section title="The center gap">
        <p className="text-sm leading-relaxed">
          ...
          that a <strong className="text-foreground">DIP chip</strong>{" "}
      ...
      <Section title="The resistor-across-the-gap rule">
        ...
        <p className="text-sm leading-relaxed mt-2">
          ...
          flow <em className="text-foreground">through</em> the component
