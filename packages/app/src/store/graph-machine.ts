...
const NODE_SIZE: Record<GraphNodeType, { width: number; height: number }> = {
  setup: { width: 160, height: 70 },
  loop: { width: 160, height: 70 },
  digital_write: { width: 180, height: 100 },
  digital_read: { width: 180, height: 100 },
  pin_mode: { width: 180, height: 90 },
  analog_write: { width: 180, height: 100 },
  analog_read: { width: 180, height: 100 },
  delay: { width: 140, height: 80 },
  millis: { width: 140, height: 70 },
  micros: { width: 140, height: 70 },
  serial_begin: { width: 180, height: 80 },
  serial_print: { width: 200, height: 100 },
  serial_read: { width: 180, height: 90 },
  if_else: { width: 180, height: 120 },
  comparison: { width: 160, height: 90 },
  logic_gate: { width: 140, height: 80 },
  math: { width: 160, height: 90 },
  map_value: { width: 180, height: 100 },
  constrain: { width: 180, height: 90 },
  variable: { width: 160, height: 90 },
  constant: { width: 140, height: 70 },
  servo_write: { width: 180, height: 100 },
  tone: { width: 180, height: 100 },
  lcd_print: { width: 200, height: 110 },
  code_block: { width: 240, height: 160 },
};
