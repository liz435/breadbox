...
function changedNodesBetween(fromV, toV){
  ...
  var known = ['1.0.1','1.0.2','1.0.3','1.0.4','1.0.5','1.0.6','1.0.7','1.0.8','1.1.0','1.1.1','1.2.0'];
  var out = [];
...
function allKnownVersions(evals){
  var versions=Object.keys(versionBuckets(evals||[]));
  var known=['1.0.0','1.0.1','1.0.2','1.0.3','1.0.4','1.0.5','1.0.6','1.0.7','1.0.8','1.1.0','1.1.1','1.2.0'];
