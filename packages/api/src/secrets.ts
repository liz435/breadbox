...
// route or agent module is imported, so the raw env slot never exists at
// the time an agent tool could introspect it.
//
...
// empty-string fallback and the downstream provider call will reject —
// far louder than a silently-missing key.
